...
**Cohort morphology (n = 39 Neutrophils):** nucleus (97.9%); cytoplasmic basophilia (97.8%); nuclear chromatin (97.5%); nuclear shape (96.1%).
...
## Agentic Diagnosis
Predicted diagnosis: **AML** (confidence 0.81). Rationale: learned classifier prediction from detection-derived features.
...
> **⚠ Flagged for mandatory human review by the reflection agent.** Reason(s): High pct_class_none and low mean detection confidence suggest data quality issues that may affect diagnostic reliability.
