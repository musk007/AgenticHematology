...
**Cohort morphology (n = 80 Myeloblasts):** nuclear chromatin (95.0%); nucleus (94.5%); cytoplasmic basophilia (89.7%); cytoplasm (89.5%).
...
> **⚠ Flagged for mandatory human review by the reflection agent.** Reason(s): High pct_class_none and low mean detection confidence suggest data quality issues despite strong classifier confidence.
