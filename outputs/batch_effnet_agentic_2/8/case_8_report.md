...
**Cohort morphology (n = 76 Lymphoblasts):** nucleus (95.2%); nuclear chromatin (72.8%).
...
> **⚠ Flagged for mandatory human review by the reflection agent.** Reason(s): High blast burden with borderline classifier confidence and significant non-WBC artifacts suggest diagnostic uncertainty.
