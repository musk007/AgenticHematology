...
## Agentic Diagnosis
Predicted diagnosis: **CML** (confidence 0.92). Rationale: learned classifier (stats features, train-split model).
...
- neutrophil differential % (supports, SHAP=+2.1155)
- myelocyte differential % (supports, SHAP=+0.3019)
- inconspicuous nucleolus attribute % (supports, SHAP=+0.0137)
- medium cell size attribute % (supports, SHAP=+0.0126)
- identified WBC cell count (opposes, SHAP=-0.0114)
