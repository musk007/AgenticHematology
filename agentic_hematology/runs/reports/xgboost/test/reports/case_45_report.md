...
## Agentic Diagnosis
Predicted diagnosis: **AML** (confidence 0.89). Rationale: learned classifier (stats features, train-split model).
...
- prominent nucleolus attribute % (supports, SHAP=+1.3246)
- small cell size attribute % (opposes, SHAP=-0.4902)
- myeloblast differential % (supports, SHAP=+0.2764)
- identified WBC cell count (supports, SHAP=+0.1986)
- inconspicuous nucleolus attribute % (supports, SHAP=+0.1756)
