...
## Agentic Diagnosis
Predicted diagnosis: **AML** (confidence 0.50). Rationale: learned classifier (stats features, train-split model).
...
- prominent nucleolus attribute % (supports, SHAP=+1.5427)
- small cell size attribute % (supports, SHAP=+0.4480)
- myeloblast differential % (opposes, SHAP=-0.2521)
- inconspicuous nucleolus attribute % (supports, SHAP=+0.2381)
- identified WBC cell count (supports, SHAP=+0.2209)
