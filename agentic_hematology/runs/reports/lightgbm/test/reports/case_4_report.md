...
- lymphoblast differential % (supports, SHAP=+5.2539)
- scanty cytoplasm attribute % (supports, SHAP=+0.8381)
- identified WBC cell count (supports, SHAP=+0.5855)
- slight cytoplasmic basophilia attribute % (opposes, SHAP=-0.0817)
- small cell size attribute % (supports, SHAP=+0.0619)
