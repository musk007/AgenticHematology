...
- lymphoblast differential % (supports, SHAP=+5.2426)
- scanty cytoplasm attribute % (supports, SHAP=+0.7861)
- identified WBC cell count (supports, SHAP=+0.5611)
- small cell size attribute % (opposes, SHAP=-0.1592)
- slight cytoplasmic basophilia attribute % (supports, SHAP=+0.1547)
