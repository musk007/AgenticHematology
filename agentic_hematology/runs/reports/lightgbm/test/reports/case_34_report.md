...
- prominent nucleolus attribute % (supports, SHAP=+2.3102)
- open nuclear chromatio attribute % (supports, SHAP=+1.1273)
- small cell size attribute % (supports, SHAP=+1.0451)
- myeloblast differential % (supports, SHAP=+0.7851)
