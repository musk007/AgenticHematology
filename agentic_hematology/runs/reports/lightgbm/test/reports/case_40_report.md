...
- eosinophil differential % (supports, SHAP=+1.5135)
- prominent nucleolus attribute % (opposes, SHAP=-0.9718)
- open nuclear chromatio attribute % (opposes, SHAP=-0.9642)
- small cell size attribute % (supports, SHAP=+0.5544)
- myeloblast differential % (supports, SHAP=+0.3246)
