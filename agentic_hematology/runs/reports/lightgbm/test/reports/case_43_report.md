...
## Agentic Diagnosis
Predicted diagnosis: **AML** (confidence 1.00). Rationale: learned classifier (stats features, train-split model).
...
- prominent nucleolus attribute % (supports, SHAP=+2.2709)
- open nuclear chromatio attribute % (supports, SHAP=+1.2111)
- small cell size attribute % (supports, SHAP=+0.9532)
- myeloblast differential % (supports, SHAP=+0.8698)
- code 2 nuclear chromatio attribute % (supports, SHAP=+0.5035)
