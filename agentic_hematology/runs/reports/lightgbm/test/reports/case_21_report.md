...
## Agentic Diagnosis
Predicted diagnosis: **CLL** (confidence 1.00). Rationale: learned classifier (stats features, train-split model).
...
- blast pool % of WBC (supports, SHAP=+10.0773)
- blasts lineage group % (supports, SHAP=+1.2551)
- open nuclear chromatio attribute % (supports, SHAP=+0.0750)
- prominent nucleolus attribute % (supports, SHAP=+0.0459)
- absent cytoplasmic vacuoles attribute % (supports, SHAP=+0.0029)
