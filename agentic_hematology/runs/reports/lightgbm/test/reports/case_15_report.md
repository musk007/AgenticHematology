...
- prominent nucleolus attribute % (supports, SHAP=+1.8719)
- small cell size attribute % (supports, SHAP=+1.0549)
- open nuclear chromatio attribute % (supports, SHAP=+0.9656)
- monoblast differential % (supports, SHAP=+0.7438)
- code 2 nuclear chromatio attribute % (opposes, SHAP=-0.5704)
