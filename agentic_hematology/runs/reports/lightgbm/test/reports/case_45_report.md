...
- prominent nucleolus attribute % (supports, SHAP=+1.8969)
- open nuclear chromatio attribute % (supports, SHAP=+1.3468)
- myeloblast differential % (supports, SHAP=+0.7492)
- small cell size attribute % (supports, SHAP=+0.6680)
- code 2 nuclear chromatio attribute % (opposes, SHAP=-0.5838)
