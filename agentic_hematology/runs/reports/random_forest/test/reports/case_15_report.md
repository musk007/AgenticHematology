...
## Agentic Diagnosis
Predicted diagnosis: **AML** (confidence 0.92). Rationale: learned classifier (stats features, train-split model).
...
- blast pool % of WBC (supports, SHAP=+0.0625)
- blasts lineage group % (supports, SHAP=+0.0610)
- metamyelocyte differential % (supports, SHAP=+0.0410)
- slight cytoplasmic basophilia attribute % (supports, SHAP=+0.0398)
- scanty cytoplasm attribute % (supports, SHAP=+0.0397)
