...
## Agentic Diagnosis
Predicted diagnosis: **CML** (confidence 0.70). Rationale: learned classifier (stats features, train-split model).
...
- blasts lineage group % (supports, SHAP=+0.0547)
- blast pool % of WBC (supports, SHAP=+0.0482)
- basophil differential % (opposes, SHAP=-0.0372)
- atypical lymphocyte differential % (supports, SHAP=+0.0335)
- lymphoid lineage group % (supports, SHAP=+0.0282)
