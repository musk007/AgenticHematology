...
- blast pool % of WBC (supports, SHAP=+0.0710)
- blasts lineage group % (supports, SHAP=+0.0689)
- metamyelocyte differential % (supports, SHAP=+0.0443)
- slight cytoplasmic basophilia attribute % (supports, SHAP=+0.0375)
- scanty cytoplasm attribute % (supports, SHAP=+0.0362)
