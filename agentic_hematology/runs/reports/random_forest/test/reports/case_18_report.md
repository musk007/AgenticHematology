...
## Agentic Diagnosis
Predicted diagnosis: **ALL** (confidence 0.75). Rationale: learned classifier (stats features, train-split model).
...
- blasts lineage group % (supports, SHAP=+0.0653)
- blast pool % of WBC (supports, SHAP=+0.0634)
- metamyelocyte differential % (supports, SHAP=+0.0382)
- slight cytoplasmic basophilia attribute % (supports, SHAP=+0.0374)
- scanty cytoplasm attribute % (supports, SHAP=+0.0354)
