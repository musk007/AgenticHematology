...
## Agentic Diagnosis
Predicted diagnosis: **CML** (confidence 0.67). Rationale: learned classifier (stats features, train-split model).
...
- basophil differential % (opposes, SHAP=-0.0564)
- blasts lineage group % (supports, SHAP=+0.0532)
- blast pool % of WBC (supports, SHAP=+0.0505)
- atypical lymphocyte differential % (supports, SHAP=+0.0317)
- lymphoid lineage group % (supports, SHAP=+0.0288)
