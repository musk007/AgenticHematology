...
## Agentic Diagnosis
Predicted diagnosis: **CLL** (confidence 0.36). Rationale: learned classifier (stats features, train-split model).
...
- blasts lineage group % (supports, SHAP=+0.0307)
- atypical lymphocyte differential % (supports, SHAP=+0.0287)
- lymphocyte differential % (opposes, SHAP=-0.0225)
- lymphoid lineage group % (supports, SHAP=+0.0221)
- blast pool % of WBC (supports, SHAP=+0.0203)
