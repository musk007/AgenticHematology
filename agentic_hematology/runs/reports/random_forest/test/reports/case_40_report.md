...
## Agentic Diagnosis
Predicted diagnosis: **AML** (confidence 0.68). Rationale: learned classifier (stats features, train-split model).
...
- blast pool % of WBC (supports, SHAP=+0.0469)
- blasts lineage group % (supports, SHAP=+0.0393)
- metamyelocyte differential % (supports, SHAP=+0.0374)
- basophil differential % (supports, SHAP=+0.0347)
- myelocyte differential % (supports, SHAP=+0.0347)
