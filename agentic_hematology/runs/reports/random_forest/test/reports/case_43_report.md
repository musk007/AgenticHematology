...
- blasts lineage group % (supports, SHAP=+0.0665)
- blast pool % of WBC (supports, SHAP=+0.0658)
- metamyelocyte differential % (supports, SHAP=+0.0442)
- basophil differential % (supports, SHAP=+0.0393)
- slight cytoplasmic basophilia attribute % (supports, SHAP=+0.0384)
