...
## Agentic Diagnosis
Predicted diagnosis: **ALL** (confidence 0.94). Rationale: learned classifier (stats features, train-split model).
...
- blasts lineage group % (supports, SHAP=+0.0748)
- blast pool % of WBC (supports, SHAP=+0.0734)
- metamyelocyte differential % (supports, SHAP=+0.0478)
- scanty cytoplasm attribute % (supports, SHAP=+0.0421)
- slight cytoplasmic basophilia attribute % (supports, SHAP=+0.0383)
