...
## Agentic Diagnosis
Predicted diagnosis: **ALL** (confidence 0.98). Rationale: learned classifier (stats features, train-split model).
...
- blast pool % of WBC (supports, SHAP=+0.0740)
- blasts lineage group % (supports, SHAP=+0.0709)
- metamyelocyte differential % (supports, SHAP=+0.0475)
- scanty cytoplasm attribute % (supports, SHAP=+0.0426)
- slight cytoplasmic basophilia attribute % (supports, SHAP=+0.0405)
