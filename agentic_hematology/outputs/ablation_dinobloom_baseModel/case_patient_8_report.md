...
**Cohort morphology (n = 78 Lymphoblasts):** nucleus (87.7%); nuclear chromatin (58.0%).
...
- `img001_c000` in `8_11_102_400_ALL.png` bbox=[29.25, 127.12, 92.44, 234.12]: Neutrophil (0.88); nuclear chromatin; nuclear shape; nucleus; cytoplasmic basophilia.
...
- `img031_c000` in `8_42_98_400_ALL.png` bbox=[273.25, 355.0, 336.75, 460.0]: Myeloblast (0.88); nuclear chromatin; nucleus; cytoplasm; cytoplasmic basophilia.
...
- `img015_c000` in `8_26_23_400_ALL.png` bbox=[434.75, 366.5, 503.25, 481.5]: Lymphoblast (0.87); nuclear chromatin; nucleus; cytoplasm; cytoplasmic basophilia.
- `img023_c000` in `8_35_108_400_ALL.png` bbox=[383.75, 49.66, 444.25, 166.38]: Lymphoblast (0.87); nuclear chromatin; nuclear shape; nucleus; cytoplasmic basophilia.
