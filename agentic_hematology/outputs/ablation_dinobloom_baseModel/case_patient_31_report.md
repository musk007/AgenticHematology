...
**Cohort morphology (n = 202 Neutrophils):** nucleus (99.7%); cytoplasmic basophilia (99.5%); nuclear shape (98.4%); nuclear chromatin (96.5%).
...
- `img025_c000` in `31_33_72_400_CML.png` bbox=[168.5, 286.25, 231.5, 399.25]: Myelocyte (0.95); nuclear chromatin; nuclear shape; nucleus; cytoplasmic basophilia.
...
- `img002_c000` in `31_12_58_400_CML.png` bbox=[327.5, 400.0, 387.5, 508.0]: Metamyelocyte (0.92); nuclear chromatin; nuclear shape; nucleus; cytoplasmic basophilia.
- `img019_c000` in `31_28_29_400_CML.png` bbox=[92.25, 314.0, 155.75, 422.5]: Myelocyte (0.91); nuclear chromatin; nuclear shape; nucleus; cytoplasmic basophilia.
- `img021_c001` in `31_2_2_400_CML.png` bbox=[249.12, 208.75, 318.0, 336.75]: Neutrophil (0.90); nuclear chromatin; nuclear shape; nucleus; cytoplasmic basophilia.
- `img022_c000` in `31_30_31_400_CML.png` bbox=[432.0, 0.0, 495.0, 84.56]: Neutrophil (0.89); nuclear chromatin; nuclear shape; nucleus; cytoplasmic basophilia.
...
- `img001_c000` in `31_11_57_400_CML.png` bbox=[340.5, 42.5, 397.0, 129.75]: Neutrophil (0.89); nuclear chromatin; nuclear shape; nucleus; cytoplasmic basophilia.