...
**Cohort morphology (n = 32 Lymphoblasts):** nucleus (81.2%); nuclear chromatin (79.4%); cytoplasmic basophilia (50.0%).
...
- `img007_c000` in `18_19_40_400_ALL.png` bbox=[471.5, 489.75, 534.5, 590.0]: Neutrophil (0.90); nuclear chromatin; nuclear shape; nucleus; cytoplasmic basophilia.
...
- `img006_c001` in `18_18_37_400_ALL.png` bbox=[200.5, 448.5, 254.0, 550.0]: Neutrophil (0.90); nuclear chromatin; nuclear shape; nucleus; cytoplasmic basophilia.
- `img023_c000` in `18_4_14_400_ALL.png` bbox=[44.38, 302.75, 106.38, 418.75]: Lymphoblast (0.89); nuclear chromatin; nucleus; cytoplasm; cytoplasmic basophilia.
- `img022_c000` in `18_37_72_400_ALL.png` bbox=[565.0, 406.0, 619.0, 503.0]: Neutrophil (0.88); nuclear chromatin; nuclear shape; nucleus; cytoplasmic basophilia.
