...
**Cohort morphology (n = 91 Myeloblasts):** nucleus (97.6%); nuclear chromatin (76.5%); cytoplasmic vacuoles (57.6%); cytoplasm (57.4%).
...
- `img002_c000` in `43_12_59_400_AML.png` bbox=[131.0, 443.0, 199.5, 538.0]: Myeloblast (0.90); nuclear chromatin; nuclear shape; nucleus.
- `img039_c000` in `43_47_40_400_AML.png` bbox=[84.75, 89.12, 157.38, 207.12]: Neutrophil (0.90); nuclear chromatin; nuclear shape; nucleus; cytoplasmic basophilia.
...
- `img032_c000` in `43_40_34_400_AML.png` bbox=[274.5, 542.0, 328.5, 632.0]: Lymphocyte (0.90); nuclear chromatin; nuclear shape; nucleus; cytoplasmic basophilia.
- `img052_c000` in `43_59_54_400_AML.png` bbox=[260.5, 169.0, 337.0, 282.75]: Myeloblast (0.90); nuclear chromatin; nucleus; cytoplasm; cytoplasmic basophilia.
- `img002_c001` in `43_12_59_400_AML.png` bbox=[365.5, 463.5, 441.5, 547.5]: Myeloblast (0.89); nuclear chromatin; nucleus; cytoplasm; cytoplasmic basophilia.
- `img044_c000` in `43_51_44_400_AML.png` bbox=[396.5, 547.0, 465.5, 640.0]: Myeloblast (0.89); nuclear chromatin; nucleus; cytoplasm; cytoplasmic basophilia.
