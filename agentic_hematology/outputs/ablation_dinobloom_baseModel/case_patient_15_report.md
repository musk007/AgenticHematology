...
**Cohort morphology (n = 60 Myeloblasts):** nucleus (96.0%); nuclear chromatin (88.7%); cytoplasmic vacuoles (81.0%); cytoplasm (78.7%).
...
- `img032_c001` in `15_40_68_400_AML.png` bbox=[344.5, 219.12, 408.5, 330.0]: Myeloblast (0.89); nuclear chromatin; nucleus; cytoplasm; cytoplasmic basophilia.
- `img033_c000` in `15_41_69_400_AML.png` bbox=[456.5, 137.38, 529.0, 247.38]: Myeloblast (0.89); nuclear chromatin; nucleus; cytoplasm; cytoplasmic basophilia.
...
- `img036_c000` in `15_44_78_400_AML.png` bbox=[132.25, 261.0, 211.25, 403.0]: Monoblast (0.88); nuclear chromatin; nucleus; cytoplasm; cytoplasmic basophilia.
...
- `img049_c000` in `15_56_30_400_AML.png` bbox=[321.0, 429.0, 389.0, 534.0]: Neutrophil (0.88); nuclear chromatin; nuclear shape; nucleus; cytoplasmic basophilia.
