...
**Cohort morphology (n = 48 Myeloblasts):** nucleus (97.6%); nuclear chromatin (92.3%); cytoplasmic basophilia (85.9%); cytoplasmic vacuoles (85.4%).
...
## Agentic Diagnosis
Predicted diagnosis: **AML** (confidence 0.92). Rationale: learned classifier prediction from aggregated differential features.
