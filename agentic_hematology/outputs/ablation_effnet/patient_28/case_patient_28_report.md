...
**Cohort morphology (n = 205 Neutrophils):** nucleus (100.0%); cytoplasmic basophilia (98.5%); cytoplasmic vacuoles (97.8%); nuclear chromatin (96.9%).
...
- `img005_c000` in `28_15_24_400_CML.png` bbox=[246.5, 253.75, 310.0, 373.25]: Myelocyte (0.96); nuclear chromatin; nuclear shape; nucleus; cytoplasm.
...
- `img024_c000` in `28_33_102_400_CML.png` bbox=[511.0, 494.25, 569.0, 598.0]: Metamyelocyte (0.92); nuclear chromatin; nuclear shape; nucleus; cytoplasm.
- `img037_c000` in `28_45_21_400_CML.png` bbox=[329.25, 328.0, 393.25, 438.0]: Myelocyte (0.92); nuclear chromatin; nuclear shape; nucleus; cytoplasm.
- `img007_c000` in `28_17_100_400_CML.png` bbox=[371.75, 393.5, 439.25, 518.5]: Metamyelocyte (0.91); nuclear chromatin; nuclear shape; nucleus; cytoplasm.
...
- `img047_c000` in `28_54_49_400_CML.png` bbox=[217.25, 346.5, 292.75, 473.5]: Metamyelocyte (0.90); nuclear chromatin; nuclear shape; nucleus; cytoplasm.
- `img004_c000` in `28_14_20_400_CML.png` bbox=[310.0, 526.0, 386.0, 640.0]: Myelocyte (0.90); nuclear chromatin; nuclear shape; nucleus; cytoplasm.