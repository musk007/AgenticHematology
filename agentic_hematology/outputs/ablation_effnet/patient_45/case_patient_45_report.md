...
**Cohort morphology (n = 80 Lymphoblasts):** nucleus (96.3%); nuclear chromatin (87.5%); cytoplasmic vacuoles (63.0%); cytoplasmic basophilia (57.3%).
...
- `img003_c000` in `45_13_68_400_AML.png` bbox=[383.75, 152.25, 448.25, 257.75]: Neutrophil (0.91); nuclear chromatin; nuclear shape; nucleus; cytoplasm.
- `img013_c000` in `45_22_19_400_AML.png` bbox=[361.0, 141.75, 400.5, 211.25]: Lymphocyte (0.90); nuclear chromatin; nuclear shape; nucleus; cytoplasm.
- `img023_c000` in `45_31_71_400_AML.png` bbox=[95.38, 247.12, 155.0, 363.0]: Neutrophil (0.89); nuclear chromatin; nuclear shape; nucleus; cytoplasm.
- `img021_c000` in `45_2_5_400_AML.png` bbox=[533.0, 372.0, 601.0, 486.0]: Neutrophil (0.89); nuclear chromatin; nuclear shape; nucleus; cytoplasm.
- `img047_c000` in `45_57_78_400_AML.png` bbox=[469.0, 302.25, 512.0, 397.75]: Neutrophil (0.89); nuclear chromatin; nuclear shape; nucleus; cytoplasm.
- `img033_c000` in `45_43_29_400_AML.png` bbox=[11.75, 340.5, 73.62, 453.5]: Neutrophil (0.89); nuclear chromatin; nuclear shape; nucleus; cytoplasm.
- `img015_c001` in `45_24_21_400_AML.png` bbox=[168.0, 217.5, 207.5, 283.5]: Lymphocyte (0.88); nuclear chromatin; nuclear shape; nucleus; cytoplasm.
