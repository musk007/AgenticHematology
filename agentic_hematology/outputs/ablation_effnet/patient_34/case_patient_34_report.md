...
**Cohort morphology (n = 22 Neutrophils):** cytoplasmic basophilia (100.0%); nuclear chromatin (100.0%); nuclear shape (100.0%); nucleus (100.0%).
...
- `img037_c000` in `34_8_8_400_AML.png` bbox=[208.25, 194.0, 281.5, 322.5]: Neutrophil (0.90); nuclear chromatin; nuclear shape; nucleus; cytoplasm.
- `img034_c000` in `34_5_5_400_AML.png` bbox=[277.0, 17.25, 346.5, 143.0]: Neutrophil (0.89); nuclear chromatin; nuclear shape; nucleus; cytoplasm.
- `img013_c000` in `34_23_27_400_AML.png` bbox=[560.0, 249.62, 640.0, 387.5]: Neutrophil (0.89); nuclear chromatin; nuclear shape; nucleus; cytoplasm.
...
- `img003_c000` in `34_13_14_400_AML.png` bbox=[47.62, 282.5, 119.5, 409.5]: Neutrophil (0.88); nuclear chromatin; nuclear shape; nucleus; cytoplasm.
- `img033_c000` in `34_4_3_400_AML.png` bbox=[339.5, 294.0, 409.0, 418.0]: Myeloblast (0.88); nuclear chromatin; nuclear shape; nucleus; cytoplasm.
- `img015_c000` in `34_25_29_400_AML.png` bbox=[9.0, 448.0, 79.06, 565.0]: Neutrophil (0.88); nuclear chromatin; nuclear shape; nucleus; cytoplasm.
- `img023_c000` in `34_32_4_400_AML.png` bbox=[479.5, 258.0, 556.5, 383.0]: Neutrophil (0.88); nuclear chromatin; nuclear shape; nucleus; cytoplasm.