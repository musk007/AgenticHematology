...
**Cohort morphology (n = 37 Neutrophils):** nuclear shape (100.0%); nucleus (100.0%); cytoplasmic basophilia (99.9%); nuclear chromatin (99.9%).
...
- `img044_c000` in `40_50_45_400_AML.png` bbox=[437.75, 35.59, 503.75, 153.38]: Neutrophil (0.90); nuclear chromatin; nuclear shape; nucleus; cytoplasm.
...
- `img042_c000` in `40_49_45_400_AML.png` bbox=[54.47, 292.25, 135.0, 413.25]: Neutrophil (0.90); nuclear chromatin; nuclear shape; nucleus; cytoplasm.
- `img038_c000` in `40_45_29_400_AML.png` bbox=[239.75, 0.0, 313.75, 115.69]: Neutrophil (0.89); nuclear chromatin; nuclear shape; nucleus; cytoplasm.
- `img013_c000` in `40_22_27_400_AML.png` bbox=[243.0, 221.0, 313.0, 335.0]: Neutrophil (0.89); nuclear chromatin; nuclear shape; nucleus; cytoplasm.
- `img042_c001` in `40_49_45_400_AML.png` bbox=[71.12, 179.0, 145.88, 299.75]: Neutrophil (0.89); nuclear chromatin; nuclear shape; nucleus; cytoplasm.
- `img013_c001` in `40_22_27_400_AML.png` bbox=[310.0, 183.25, 356.0, 264.75]: Lymphocyte (0.88); nuclear chromatin; nuclear shape; nucleus; cytoplasm.