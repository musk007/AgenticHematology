...
**Cohort morphology (n = 34 Lymphoblasts):** nuclear chromatin (92.6%); nucleus (91.5%); cytoplasm (77.3%); cytoplasmic vacuoles (65.2%).
...
- `img030_c000` in `6_39_31_400_ALL.png` bbox=[32.56, 212.12, 108.19, 360.0]: Neutrophil (0.88); nuclear chromatin; nuclear shape; nucleus; cytoplasm.
- `img033_c000` in `6_41_35_400_ALL.png` bbox=[2.59, 335.25, 52.28, 425.75]: Lymphoblast (0.88); nuclear chromatin; nuclear shape; nucleus; cytoplasm.
- `img009_c001` in `6_19_50_400_ALL.png` bbox=[370.0, 352.5, 443.0, 459.5]: Myeloblast (0.88); nuclear chromatin; nuclear shape; nucleus; cytoplasm.