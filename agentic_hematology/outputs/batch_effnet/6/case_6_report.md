...
**Cohort morphology (n = 25 Lymphoblasts):** nucleus (95.4%); nuclear chromatin (84.7%); cytoplasmic basophilia (61.5%); nuclear shape (50.8%).
...
> **⚠ Flagged for mandatory human review by the reflection agent.** Reason(s): High pct_class_none and low mean detection confidence suggest data quality issues despite clear blast burden.
