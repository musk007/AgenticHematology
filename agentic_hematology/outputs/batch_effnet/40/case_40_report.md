...
**Cohort morphology (n = 43 Neutrophils):** nucleus (100.0%); nuclear chromatin (99.3%); cytoplasmic basophilia (98.4%); nuclear shape (96.0%).
...
> **⚠ Flagged for mandatory human review by the reflection agent.** Reason(s): High pct_class_none and low classifier confidence suggest unreliable evidence despite blast presence.
