...
**Cohort morphology (n = 43 Neutrophils):** nucleus (99.9%); cytoplasmic basophilia (99.7%); nuclear chromatin (99.6%); cytoplasmic vacuoles (99.5%).
...
## Agentic Diagnosis
Predicted diagnosis: **AML** (confidence 0.73). Rationale: learned classifier prediction from detection-derived features.
