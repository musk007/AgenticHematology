...
**Cohort morphology (n = 205 Neutrophils):** nuclear shape (99.6%); cytoplasmic basophilia (99.1%); nucleus (99.0%); cytoplasmic vacuoles (97.8%).
...
## Agentic Diagnosis
Predicted diagnosis: **CML** (confidence 0.52). Rationale: learned classifier prediction from detection-derived features.
