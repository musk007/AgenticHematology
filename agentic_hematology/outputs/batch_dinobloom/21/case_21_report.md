...
**Cohort morphology (n = 215 Atypical lymphocytes):** nucleus (93.2%); nuclear shape (93.1%); nuclear chromatin (82.3%); cytoplasmic basophilia (80.5%).
...
## Agentic Diagnosis
Predicted diagnosis: **ALL** (confidence 0.36). Rationale: learned classifier prediction from detection-derived features.
