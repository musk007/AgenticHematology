...
**Cohort morphology (n = 23 Neutrophils):** cytoplasmic basophilia (100.0%); cytoplasmic vacuoles (100.0%); nuclear chromatin (100.0%); nuclear shape (100.0%).
...
## Agentic Diagnosis
Predicted diagnosis: **AML** (confidence 0.95). Rationale: learned classifier prediction from aggregated differential features.
...
> **⚠ Flagged for mandatory human review by the reflection agent.** Reason(s): High blast burden (57.6%) with borderline classifier confidence and significant non-WBC noise
