...
**Cohort morphology (n = 30 Lymphoblasts):** nucleus (92.5%); nuclear chromatin (84.4%); cytoplasmic basophilia (76.7%); cytoplasm (57.8%).
...
## Agentic Diagnosis
Predicted diagnosis: **ALL** (confidence 0.75). Rationale: learned classifier prediction from aggregated differential features.
