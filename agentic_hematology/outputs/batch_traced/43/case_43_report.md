...
**Cohort morphology (n = 97 Myeloblasts):** nucleus (100.0%); nuclear chromatin (96.4%); cytoplasmic vacuoles (92.2%); cytoplasm (91.9%).
...
## Agentic Diagnosis
Predicted diagnosis: **AML** (confidence 0.96). Rationale: learned classifier prediction from aggregated differential features.
