...
> **⚠ Flagged for mandatory human review by the reflection agent.** Reason(s): High blast percentage with borderline detection quality and significant non-WBC noise
